...
def kullanici_modal_takip_et_cikar(request):
    ...
    #kendi profilimmiş gibi hareket ediyoruz ve kendi takipçilerimi tekrardan çekiyorum
    ...
    if owner == request.user.username:
        ...
        html_render_takip_durum = render_to_string('auths/profile/include/fallowing/fallowing_partion.html', context=context,
                                request=request)
...
def sub_kullanici_takip_et_cikar(request):
    ...
    else:  # burada takipten çıkarma işlemini gerçekleştireceğiz
        Fallowing.kullanici_takipten_cikar(fallower=fallower, fallowed=fallowed)
...
def fallowed_or_fallowers_list(request, fallow_type):
    ...
    if fallow_type == 'fallowed':
        ...
        html = render_to_string('fallowing/profile/include/fallowing_fallowed_list.html', context={
            'fallowing': takip_edilenler, 'fallow_type':fallow_type, 'my_fallowed':my_fallowed
        }, request=request)
